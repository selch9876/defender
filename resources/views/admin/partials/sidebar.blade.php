...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        ...
        <li><a><i class="fa fa-user"></i> Objects <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="{{ route('game-object.create') }}">Add Object</a></li>
            <li><a href="{{ route('admin.game-objects') }}">Objects</a></li>
          </ul>
        </li>
